...
def get_score(xml_path, weather_result):
    ...
    try:
        ...
        item += 1
        if 19.99 / 3.6 <= veh_speed <= 40.01 / 3.6 and 150 <= abs(distance) <= 200 and veh_acc <= 5 and veh_acc_target == 0 and veh_car_type == 'Audi_A3_2009_red':
            score += 1
...
if __name__ == '__main__':
    score = get_score('/home/tang/xml/pro/real/aeblka_1.xml', Weather.SNOW)
    print(score)
