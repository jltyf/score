...
def get_score(xml_path, weather_result):
    ...
    try:
        ...
        if veh_speed == 0:
            score += 1
            xml_score_detail = xml_score_detail + f'{item}.障碍车处于静止状态,得1分;<br/>'
        else:
            xml_score_detail = xml_score_detail + f'{item}.障碍车不处于静止状态,不得分;<br/>'
        item += 1
        if abs(distance) == 150:
            score += 1
...
if __name__ == '__main__':
    # xml = '/home/tang/20220627/aeb_1.xml'
    xml='/home/tang/20220627/upload.xml'
    weather = Weather.RAIN
    # weather = Weather.SNOW
    get_score(xml, weather)